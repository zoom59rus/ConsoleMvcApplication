...
public final class UserMenu {
    ...
    public void searchUserMenu() {
        ...
        switch (select) {
            case 1: {
                userView.searchUserDialog(1);
                sleep();
                searchUserMenu();
            }
            case 2: {
                userView.searchUserDialog(2);
                sleep();
                searchUserMenu();
            }
            case 3: {
                userView.searchUserDialog(3);
                sleep();
                searchUserMenu();
            }
            case 4: {
                userView.searchUserDialog(4);
                sleep();
                searchUserMenu();
            }
            case 5: {
                userView.searchUserDialog(5);
                sleep();
                searchUserMenu();
            }
            case 6: {
